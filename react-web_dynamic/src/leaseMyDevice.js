...
const LeaseMyDevice = () => {
    ...
    const [leased_to, setLeasedTo] = useState(1)
        ...
        <div className="body">
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div className="input-container ic1">
                    ...
                    <label for="devicename" className="placeholder">Device name</label>
                </div>
                <div className="input-container ic2">
                    ...
                    <label for="price" className="placeholder">Price per day</label>
                </div>
                <div>
                    <div className="xlc">
